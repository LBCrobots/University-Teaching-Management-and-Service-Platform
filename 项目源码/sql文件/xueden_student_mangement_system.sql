...
) ENGINE = InnoDB AUTO_INCREMENT = 29 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `s_student_score` VALUES (82, 1, '2024-03-08 05:40:09.106000', '初始成绩', 1, '2024-03-08 05:40:09.107000', 0, '未批改', 1, 7, 6);
INSERT INTO `s_student_score` VALUES (83, 1, '2024-03-08 05:40:09.120000', '初始成绩', 1, '2024-03-08 05:47:21.707000', 90, '已批改', 1, 8, 6);
INSERT INTO `s_student_score` VALUES (84, 1, '2024-03-08 05:47:37.502000', '初始成绩', 1, '2024-03-08 05:47:37.502000', 0, '未批改', 2, 11, 9);
INSERT INTO `s_student_score` VALUES (85, 1, '2024-03-08 05:47:37.505000', '初始成绩', 1, '2024-03-08 05:47:37.505000', 0, '未批改', 2, 12, 9);

-- ----------------------------
-- Table structure for s_student_subject
-- ----------------------------
DROP TABLE IF EXISTS `s_student_subject`;
CREATE TABLE `s_student_subject`  (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `create_by` bigint NULL DEFAULT NULL,
  `create_time` datetime(6) NOT NULL,
  ...
  INDEX `FKfb1pcum4u0xlbod236kmngx4f`(`student_id` ASC) USING BTREE,
  INDEX `FK8mac4aaiivjtr0kd4kpyt4vm5`(`gradeclass_id` ASC) USING BTREE,
  CONSTRAINT `s_student_subject_ibfk_1` FOREIGN KEY (`gradeclass_id`) REFERENCES `s_grade_class` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `s_student_subject_ibfk_2` FOREIGN KEY (`student_id`) REFERENCES `s_student` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `s_student_subject_ibfk_3` FOREIGN KEY (`course_id`) REFERENCES `s_course` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 86 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '学生成绩表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of s_student_subject
-- ----------------------------
INSERT INTO `s_student_subject` VALUES (33, 1, '2022-12-20 10:07:32.817000', '', 1, '2022-12-20 10:08:02.795000', 89, '已批改', 2, 1, 1);
INSERT INTO `s_student_subject` VALUES (34, 1, '2022-12-20 10:07:32.833000', '', 1, '2022-12-20 10:07:56.206000', 82, '已批改', 2, 4, 1);
INSERT INTO `s_student_subject` VALUES (35, 1, '2022-12-20 10:08:13.135000', '', 1, '2022-12-20 10:08:35.563000', 100, '已批改', 1, 3, 5);
INSERT INTO `s_student_subject` VALUES (36, 1, '2022-12-20 10:08:13.140000', '', 1, '2022-12-20 10:08:29.790000', 98, '已批改', 1, 5, 5);
INSERT INTO `s_student_subject` VALUES (37, 1, '2022-12-20 10:08:13.145000', '', 1, '2022-12-21 03:29:28.934000', 68, '已批改', 1, 6, 5);
INSERT INTO `s_student_subject` VALUES (38, 1, '2022-12-20 10:10:05.151000', '', 1, '2022-12-20 10:10:18.330000', 98, '已批改', 1, 1, 1);
INSERT INTO `s_student_subject` VALUES (39, 1, '2022-12-20 10:10:05.156000', '', 1, '2022-12-21 01:29:28.455000', 59, '已批改', 1, 4, 1);
INSERT INTO `s_student_subject` VALUES (40, 1, '2022-12-21 07:10:46.872000', '', 1, '2022-12-21 07:10:56.101000', 52, '已批改', 1, 13, 1);
INSERT INTO `s_student_subject` VALUES (41, 1, '2022-12-21 07:10:46.877000', '', 1, '2022-12-21 07:11:04.504000', 66, '已批改', 1, 14, 1);
INSERT INTO `s_student_subject` VALUES (42, 1, '2022-12-21 07:10:46.881000', '', 1, '2022-12-21 07:11:09.886000', 77, '已批改', 1, 15, 1);
INSERT INTO `s_student_subject` VALUES (43, 1, '2022-12-21 07:10:46.890000', '', 1, '2022-12-21 07:11:17.568000', 88, '已批改', 1, 16, 1);
INSERT INTO `s_student_subject` VALUES (44, 1, '2022-12-21 07:10:46.894000', '', 1, '2022-12-21 07:11:27.049000', 55, '已批改', 1, 17, 1);
INSERT INTO `s_student_subject` VALUES (45, 1, '2022-12-21 07:10:46.899000', '', 1, '2022-12-21 07:11:33.257000', 68, '已批改', 1, 18, 1);
INSERT INTO `s_student_subject` VALUES (46, 1, '2022-12-21 07:10:46.905000', '', 1, '2022-12-21 07:11:41.978000', 84, '已批改', 1, 19, 1);
INSERT INTO `s_student_subject` VALUES (47, 1, '2022-12-21 07:10:46.909000', '', 1, '2022-12-21 07:11:51.490000', 58, '已批改', 1, 20, 1);
INSERT INTO `s_student_subject` VALUES (48, 1, '2022-12-21 07:10:46.913000', '', 1, '2022-12-21 07:11:59.425000', 100, '已批改', 1, 21, 1);
INSERT INTO `s_student_subject` VALUES (49, 1, '2022-12-22 05:10:53.235000', '', 1, '2022-12-22 05:12:14.932000', 88, '已批改', 3, 1, 1);
INSERT INTO `s_student_subject` VALUES (50, 1, '2022-12-22 05:10:53.265000', '', 1, '2022-12-22 05:12:07.171000', 94, '已批改', 3, 4, 1);
INSERT INTO `s_student_subject` VALUES (51, 1, '2022-12-22 05:10:53.271000', '', 1, '2022-12-22 05:12:00.644000', 81, '已批改', 3, 13, 1);
INSERT INTO `s_student_subject` VALUES (52, 1, '2022-12-22 05:10:53.278000', '', 1, '2022-12-22 05:11:53.845000', 43, '已批改', 3, 14, 1);
INSERT INTO `s_student_subject` VALUES (53, 1, '2022-12-22 05:10:53.286000', '', 1, '2022-12-22 05:11:48.443000', 68, '已批改', 3, 15, 1);
INSERT INTO `s_student_subject` VALUES (54, 1, '2022-12-22 05:10:53.291000', '', 1, '2022-12-22 05:11:38.904000', 90, '已批改', 3, 16, 1);
INSERT INTO `s_student_subject` VALUES (55, 1, '2022-12-22 05:10:53.296000', '', 1, '2022-12-22 05:11:32.396000', 75, '已批改', 3, 17, 1);
INSERT INTO `s_student_subject` VALUES (56, 1, '2022-12-22 05:10:53.302000', '', 1, '2022-12-22 05:11:25.756000', 85, '已批改', 3, 18, 1);
INSERT INTO `s_student_subject` VALUES (57, 1, '2022-12-22 05:10:53.307000', '', 1, '2022-12-22 05:11:18.744000', 56, '已批改', 3, 19, 1);
INSERT INTO `s_student_subject` VALUES (58, 1, '2022-12-22 05:10:53.312000', '', 1, '2022-12-22 05:11:12.436000', 77, '已批改', 3, 20, 1);
INSERT INTO `s_student_subject` VALUES (59, 1, '2022-12-22 05:10:53.317000', '', 1, '2022-12-22 05:11:07.113000', 69, '已批改', 3, 21, 1);
INSERT INTO `s_student_subject` VALUES (60, 1, '2022-12-22 05:12:59.515000', '', 1, '2022-12-22 05:14:12.996000', 99, '已批改', 3, 3, 5);
INSERT INTO `s_student_subject` VALUES (61, 1, '2022-12-22 05:12:59.519000', '', 1, '2022-12-22 05:14:06.403000', 92, '已批改', 3, 5, 5);
INSERT INTO `s_student_subject` VALUES (62, 1, '2022-12-22 05:12:59.523000', '', 1, '2022-12-22 05:14:00.899000', 88, '已批改', 3, 6, 5);
INSERT INTO `s_student_subject` VALUES (63, 1, '2022-12-22 05:12:59.527000', '', 1, '2022-12-22 05:13:51.683000', 71, '已批改', 3, 22, 5);
INSERT INTO `s_student_subject` VALUES (64, 1, '2022-12-22 05:12:59.531000', '', 1, '2022-12-22 05:13:46.450000', 64, '已批改', 3, 23, 5);
INSERT INTO `s_student_subject` VALUES (65, 1, '2022-12-22 05:12:59.534000', '', 1, '2022-12-22 05:13:39.419000', 60, '已批改', 3, 24, 5);
INSERT INTO `s_student_subject` VALUES (66, 1, '2022-12-22 05:12:59.541000', '', 1, '2022-12-22 05:13:34.615000', 59, '已批改', 3, 25, 5);
INSERT INTO `s_student_subject` VALUES (67, 1, '2022-12-22 05:12:59.545000', '', 1, '2022-12-22 05:13:29.741000', 58, '已批改', 3, 26, 5);
INSERT INTO `s_student_subject` VALUES (68, 1, '2022-12-22 05:12:59.548000', '', 1, '2022-12-22 05:13:24.883000', 67, '已批改', 3, 27, 5);
INSERT INTO `s_student_subject` VALUES (69, 1, '2022-12-22 05:12:59.552000', '', 1, '2022-12-22 05:13:19.915000', 69, '已批改', 3, 28, 5);
INSERT INTO `s_student_subject` VALUES (70, 1, '2022-12-22 05:12:59.556000', '', 1, '2022-12-22 05:13:13.948000', 77, '已批改', 3, 29, 5);
INSERT INTO `s_student_subject` VALUES (71, 1, '2022-12-22 05:15:18.549000', '', 1, '2022-12-22 05:16:17.435000', 77, '已批改', 4, 1, 1);
INSERT INTO `s_student_subject` VALUES (72, 1, '2022-12-22 05:15:18.553000', '', 1, '2022-12-22 05:16:10.259000', 94, '已批改', 4, 4, 1);
INSERT INTO `s_student_subject` VALUES (73, 1, '2022-12-22 05:15:18.561000', '', 1, '2022-12-22 05:16:03.164000', 73, '已批改', 4, 13, 1);
INSERT INTO `s_student_subject` VALUES (74, 1, '2022-12-22 05:15:18.567000', '', 1, '2022-12-22 05:15:56.420000', 86, '已批改', 4, 14, 1);
INSERT INTO `s_student_subject` VALUES (75, 1, '2022-12-22 05:15:18.574000', '', 1, '2022-12-22 05:15:50.964000', 58, '已批改', 4, 15, 1);
INSERT INTO `s_student_subject` VALUES (76, 1, '2022-12-22 05:15:18.580000', '', 1, '2022-12-22 05:15:46.315000', 66, '已批改', 4, 16, 1);
INSERT INTO `s_student_subject` VALUES (77, 1, '2022-12-22 05:15:18.593000', '', 1, '2022-12-22 05:15:42.243000', 53, '已批改', 4, 17, 1);
INSERT INTO `s_student_subject` VALUES (78, 1, '2022-12-22 05:15:18.599000', '', 1, '2022-12-22 05:15:37.339000', 87, '已批改', 4, 18, 1);
INSERT INTO `s_student_subject` VALUES (79, 1, '2022-12-22 05:15:18.604000', '', 1, '2022-12-22 05:15:32.932000', 96, '已批改', 4, 19, 1);
INSERT INTO `s_student_subject` VALUES (80, 1, '2022-12-22 05:15:18.611000', '', 1, '2022-12-22 05:15:27.060000', 75, '已批改', 4, 20, 1);
INSERT INTO `s_student_subject` VALUES (81, 1, '2022-12-22 05:15:18.617000', '', 1, '2022-12-22 05:15:22.739000', 44, '已批改', 4, 21, 1);
INSERT INTO `s_student_subject` VALUES (82, 1, '2024-03-08 05:40:09.106000', '', 1, '2024-03-08 05:40:09.107000', 0, '未批改', 1, 7, 6);
INSERT INTO `s_student_subject` VALUES (83, 1, '2024-03-08 05:40:09.120000', '', 1, '2024-03-08 05:47:21.707000', 90, '已批改', 1, 8, 6);
INSERT INTO `s_student_subject` VALUES (84, 1, '2024-03-08 05:47:37.502000', '', 1, '2024-03-08 05:47:37.502000', 0, '未批改', 2, 11, 9);
INSERT INTO `s_student_subject` VALUES (85, 1, '2024-03-08 05:47:37.505000', '', 1, '2024-03-08 05:47:37.505000', 0, '未批改', 2, 12, 9);
...
) ENGINE = InnoDB AUTO_INCREMENT = 8 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '教师信息表' ROW_FORMAT = Dynamic;
...
INSERT INTO `s_teacher` VALUES (8, 1, '2022-12-16 12:27:26.298000', '天才人物，千竹教教主，自创《大衍决》、《傀儡术》。万年前自知无望突破化神，把元神寄付傀儡之上存于世间。', 1, '2024-03-08 03:47:33.295000', '大衍神君', '13800138008', '11184629', '男', 't008', 8);
...
INSERT INTO `sys_role` VALUES (3, 1, '2024-03-08 05:53:37.943000', '学生', 1, '2024-03-08 05:53:37.944000', 'ROLE_STUDENGT', '学生');
...
) ENGINE = InnoDB AUTO_INCREMENT = 14 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '系统用户信息表' ROW_FORMAT = Dynamic;
